"""
    The following code has been borrowed from the repo:
    https://github.com/handongfeng/MNIST-center-loss
    and CenterLossLayer has been used to modify
    https://github.com/Vastlab/Reducing-Network-Agnostophobia
    to incorporate center-loss additional to the objectosphere loss.
    on 02/23/2020 by Touqeer Ahmad (sh.touqeerahmad@gmail.com).
"""
